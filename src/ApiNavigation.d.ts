...
export declare class ApiNavigation {
   ...
   */
  _appendTypeItem(item: object, target: object): void;
   ...
   * @param item Type item declaration
   */
  _appendSecurityItem(item: object, target: object): void;
   ...
   * @param item Type item declaration
   */
  _appendDocumentationItem(item: object, target: object): void;
   ...
   */
  _appendEndpointItem(item: object, target: object): void;
  ...
  _toggleSection(node: Element): void;

  /**
   * Selectes new item in the menu.
   */
  _selectItem(node: Element): void;
   ...
   */
  _computeRenderSummary(summary: boolean, isFragment: boolean): void;
   ...
   */
  _getFilteredType(prop: string): object[]|undefined;
   ...
   */
  _getFilteredEndpoints(): object[]|undefined;
   ...
   */
  _endpointsTemplate(): TemplateResult|undefined;
  _endpointTemplate(item: object): TemplateResult;
  _methodTemplate(endpointItem: object, methodItem: object): TemplateResult;

  /**
   * Renders a template for documentation list.
   */
  _documentationTemplate(): TemplateResult|undefined;

  /**
   * Renders a template for types list.
   */
  _typesTemplate(): TemplateResult|undefined;

  /**
   * Renders a template for security schemes list.
   */
  _securityTemplate(): TemplateResult|undefined;
