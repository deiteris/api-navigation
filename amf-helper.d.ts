 ...
 * amf.
 */
declare class ApiNavigationAmfHelper {
   ...
   * @returns API spec
   */
  ensureAmfModel(amf: object|any[]|null): object|null|undefined;
   ...
   * @returns True if model has `type` defined.
   */
  hasType(model: object|null, type: String|null): Boolean|null;
   ...
   */
  traverseDeclarations(target: object|null): void;
   ...
   *
   * @param def Property AMF definition
   * @param property Name of the schema.
   * @returns Value of the property or undefined if not set.
   */
  _computeShaclProperty(def: object|null, property: String|null): any|null|undefined;
   ...
   * @returns Value of the property or undefined if not set.
   */
  _computeSchemaProperty(def: object|null, property: String|null): any|null|undefined;
   ...
   * @returns Value of the property or undefined if not set.
   */
  _computeProperty(def: object|null, key: String|null): any|null|undefined;
}
